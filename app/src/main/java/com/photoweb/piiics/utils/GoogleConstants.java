...
public class GoogleConstants {
    ...
    /** Google API KEY */
    public static String URL_EXTN_API_KEY = "&key=AIzaSyAG9F83BhsjkKuJc4IeT1g97tyUaiuB_y8";

    public static String GOOGLE_API_KEY = "AIzaSyAG9F83BhsjkKuJc4IeT1g97tyUaiuB_y8";
    ...
    public static String JSON_FIELD_IDENTIFIER = "identifier";
