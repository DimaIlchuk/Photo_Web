...
/**
 * Created by dnizard on 20/11/2017.
 */

public class PrintProductFragment extends BaseFragment  {

    @BindView(R.id.describe_print) TextView describe;

    ProductPageActivity activity;

    @Override
    protected int getLayoutResource() {
        return R.layout.fragment_printproduct;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        describe.setText(Html.fromHtml(getString(R.string.PRINT_PAGE_DESCRIBE)));
